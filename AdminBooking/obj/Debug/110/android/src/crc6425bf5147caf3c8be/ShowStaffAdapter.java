...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("AdminBooking.ShowStaffAdapter, OCPIO", ShowStaffAdapter.class, __md_methods);
	}


	public ShowStaffAdapter ()
	{
		super ();
		if (getClass () == ShowStaffAdapter.class)
			mono.android.TypeManager.Activate ("AdminBooking.ShowStaffAdapter, OCPIO", "", this, new java.lang.Object[] {  });
	}
