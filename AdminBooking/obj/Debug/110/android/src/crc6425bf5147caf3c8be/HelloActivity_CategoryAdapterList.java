...
public class HelloActivity_CategoryAdapterList
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("AdminBooking.HelloActivity+CategoryAdapterList, OCPIO", HelloActivity_CategoryAdapterList.class, __md_methods);
	}


	public HelloActivity_CategoryAdapterList ()
	{
		super ();
		if (getClass () == HelloActivity_CategoryAdapterList.class)
			mono.android.TypeManager.Activate ("AdminBooking.HelloActivity+CategoryAdapterList, OCPIO", "", this, new java.lang.Object[] {  });
	}
